...
export function BinderSlot({ card, collected, onSelect }: BinderSlotProps) {
  ...
  if (!collected) {
    return (
      <div className="aspect-[0.718] rounded-xl bg-white/5 border border-white/5 flex flex-col items-center justify-center gap-2 opacity-40">
  ...
  return (
    <button
      className="aspect-[0.718] rounded-xl border overflow-hidden relative group cursor-pointer transition-all hover:scale-105 hover:z-10"
      style={{
